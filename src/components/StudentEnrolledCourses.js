...
const StudentOpenCourses = ({ courses, userEnrollments, onAddFeedback }) => {
    ...
    return (
        <>
            {filteredCourses.length === 0 && <div className="noCourses">Et ole ilmoittauneena käynnissä olevilla kursseilla. Voit ilmoittautua toteutuksiin ylläolevasta listasta.</div>}
